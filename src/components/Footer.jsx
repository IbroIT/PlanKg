...
export default function Footer() {
  ...
  return (
    <>
      <footer className="bg-linear-to-b from-[#1E2A3A] to-[#0f1724] text-white mt-auto z-10 relative">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 text-[#F4B942] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Decorative Elements */}
      <div className="bg-linear-to-r from-[#F4B942] to-transparent h-1"></div>
    </footer>
    </>
  );
}